      ...
      bankAccount.prototype.deposit = function (dAmount) {
        if (isNaN(parseFloat(dAmount))) {
          ...
          return console.log(
            `you have deposited ${dAmount} and this is your balance ${(this.balance +=
              dAmount)}`
          );
        }
      };
      ...
      bankAccount.prototype.withdraw = function (wAmount) {
        if (wAmount > this.balance) {
          return console.log(
            `you do not have sufficient balance in your account. Your account balance is ${this.balance}`
          );
        } else {
          return console.log(
            `you have withdrawn ${wAmount} and this is your balance ${(this.balance -=
              wAmount)}`
          );
        }
      };
